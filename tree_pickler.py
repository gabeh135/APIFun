...
interview_tree = ["Attribute", "level", ["Value", "Junior", ["Attribute", "phd", ["Value", "yes", ["Leaf", "False", 2, 5]], ["Value", "no", ["Leaf", "True", 3, 5]]]], ["Value", "Mid", ["Leaf", "True", 4, 14]], ["Value", "Senior", ["Attribute", "tweets", ["Value", "no", ["Leaf", "False", 3, 5]], ["Value", "yes", ["Leaf", "True", 2, 5]]]]]
...
# in anohter python process, possibly running on a diff machine (server)
# imagine you now need to save it for using in your web app on a server later
